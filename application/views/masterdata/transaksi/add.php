                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                ...
                                <form action="<?= base_url('masterdata/add_transaksi'); ?>" method="post">
                                    ...
                                    <a href="<?= base_url('masterdata/transaksi'); ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali</a>
                                    <button type="submit" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Transaksi</button>
                                </form>
                            </div>
